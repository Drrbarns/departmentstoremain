...
export function generateMetadata({
  ...
  description = 'Shop dresses, electronics, bags, shoes and more at Discount Discovery Zone. Locally sourced and imported quality products delivered across Ghana.',
  keywords = [],
